...
namespace pastel
{
  namespace sph
  {
    ...
    inline void update_densities(Force const& force, NeighborList const& neighbor_list, System& system)
    {
      ...
      ::pastel::sph::update_densities_detail::update_densities<is_sph_particles_without_divergences, is_partner_data_accessible, has_key_mass, has_partner_mass>::call(
        force, neighbor_list,
