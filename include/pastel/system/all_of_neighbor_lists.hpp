#ifndef PASTEL_SYSTEM_ALL_OF_NEIGHBOR_LISTS_HPP
# define PASTEL_SYSTEM_ALL_OF_NEIGHBOR_LISTS_HPP
...
namespace pastel
{
  namespace system
  {
    namespace all_of_neighbor_lists_detail
    {
      ...
      struct nth_step
      {
        ...
        static bool call(System const& system, Function&& function)
        {
          return function(::pastel::system::neighbor_list<n>(system), system)
            ...
            && ::pastel::system::all_of_neighbor_lists_detail::nth_step<n+4u, last, System>::call(
    ...
    template <typename System, typename Function>
    inline bool all_of_neighbor_lists(System const& system, Function&& function)
    {
      return ::pastel::system::all_of_neighbor_lists_detail::nth_step<0u, ::pastel::system::meta::neighbor_list_tuple_size_of<System const>::value, System>::call(
        system, std::forward<Function>(function));
    }
  } // namespace system
} // namespace pastel
...
#endif // PASTEL_SYSTEM_ALL_OF_NEIGHBOR_LISTS_HPP
