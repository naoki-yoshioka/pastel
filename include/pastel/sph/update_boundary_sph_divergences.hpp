...
#ifndef PASTEL_SPH_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
# define PASTEL_SPH_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
...
namespace pastel
{
  namespace sph
  {
    ...
    inline void update_boundary_sph_divergences(Force const& force, NeighborList const& neighbor_list, System& system)
    {
      ...
      ::pastel::sph::update_boundary_sph_divergences_detail::update_boundary_sph_divergences<has_divergences, is_partner_data_accessible, has_key_mass, has_partner_mass>::call(
        force, neighbor_list,
...
#endif // PASTEL_SPH_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
