    ...
    class simple_newtonian_sph_particle final
    {
     ...
     public:
      ...
      constexpr simple_newtonian_sph_particle(
        ...
        scalar_type const& density, scalar_type const& density_force, scalar_type const& pressure)
        : position_{position},
          velocity_{velocity},
          force_{force},
          density_{density},
      ...
      constexpr simple_newtonian_sph_particle(
        ...
        scalar_type&& density, scalar_type&& density_force, scalar_type&& pressure)
