...
BOOST_AUTO_TEST_CASE(lennard_jones_collisions_test, * boost::unit_test::tolerance(0.001))
{
  ...
  // Fixed Neighbor List
  using fixed_neighbor_list_type = pastel::neighbor::fixed_neighbor_list<force_type>;
  ...
  pastel::system::update_forces(fixed_system);
  ...
  pastel::system::update_forces(brute_force_system);
