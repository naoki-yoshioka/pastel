    ...
    class simple_newtonian_sph_particle final
    {
     ...
     public:
      ...
      constexpr simple_newtonian_sph_particle(
        point_type const& position, vector_type const& velocity, vector_type const& force, scalar_type const& density, scalar_type const& pressure)
        : position_{position},
          velocity_{velocity},
          force_{force},
          density_{density},
      ...
      constexpr simple_newtonian_sph_particle(
        point_type&& position, vector_type&& velocity, vector_type&& force, scalar_type&& density, scalar_type&& pressure)
