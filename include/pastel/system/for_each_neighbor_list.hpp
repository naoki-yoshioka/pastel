...
namespace pastel
{
  namespace system
  {
    namespace for_each_neighbor_list_detail
    {
      ...
      struct nth_step
      {
        ...
        static void call(System& system, Function&& function)
        {
          ...
          ::pastel::system::for_each_neighbor_list_detail::nth_step<n+4u, last, System>::call(
      ...
      struct nth_step<last-3u, last>
      {
        ...
        static void call(System& system, Function&& function)
        {
          function(::pastel::system::neighbor_list<last-3u>(system), system);
    ...
    {
      ::pastel::system::for_each_neighbor_list_detail::nth_step<0u, ::pastel::system::meta::neighbor_list_tuple_size_of<System const>::value, System>::call(
        system, std::forward<Function>(function));
    }
  } // namespace system
} // namespace pastel
