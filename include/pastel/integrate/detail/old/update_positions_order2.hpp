#ifndef PASTEL_INTEGRATE_DETAIL_UPDATE_POSITIONS_ORDER2_HPP
# define PASTEL_INTEGRATE_DETAIL_UPDATE_POSITIONS_ORDER2_HPP
...
namespace pastel
{
  namespace integrate
  {
    namespace detail
    {
      namespace update_positions_order2_detail
      {
        ...
        struct update_positions<true>
        {
          ...
          static void call(Particles&&, Time, Time, ::pastel::container::mobility_tags::immobile)
          { }

          template <typename Particles, typename Time>
          static void call(Particles&& particles, Time time_step, Time half_squared_time_step, ::pastel::container::mobility_tags::mobile)
          {
          ...
          template <typename Particles, typename Time>
          static void call(Particles&& particles, Time time_step, Time half_squared_time_step, ::pastel::container::mobility_tags::partially_mobile)
          {
            auto const positions_data = particles.template data< ::pastel::particle::tags::position >();
            auto const velocities_data = particles.template data< ::pastel::particle::tags::velocity >();
            auto const forces_data = particles.template data< ::pastel::particle::tags::force >();
      ...
      template <typename Particles, typename Time>
      inline void update_positions_order2(Particles& particles, Time time_step)
      {
        ...
        using update_positions_func
          = ::pastel::integrate::detail::update_positions_order2_detail::update_positions<is_data_accessible>;
        using mobility_tag
          = typename ::pastel::container::meta::mobility_tag_of<Particles>::type;
        update_positions_func::call(particles, time_step, time_step * time_step / Time{2}, mobility_tag{});
      }
    } // namespace detail
  } // namespace integrate
} // namespace pastel
...
#endif // PASTEL_INTEGRATE_DETAIL_UPDATE_POSITIONS_ORDER2_HPP
