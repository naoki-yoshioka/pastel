#ifndef PASTEL_CONTAINER_ALIGNED_PARTICLES_HPP
# define PASTEL_CONTAINER_ALIGNED_PARTICLES_HPP
...
namespace pastel
{
  namespace container
  {
    ...
    using aligned_particles
      = ::pastel::container::particles<
          dimension_, MobilityTag, num_integration_vectors_, num_property_vectors_, num_property_scalars_,
          Value, Point, Vector,
...
#endif // PASTEL_CONTAINER_ALIGNED_PARTICLES_HPP
