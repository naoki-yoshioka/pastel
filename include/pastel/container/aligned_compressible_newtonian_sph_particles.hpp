#ifndef PASTEL_CONTAINER_ALIGNED_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLES_HPP
# define PASTEL_CONTAINER_ALIGNED_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLES_HPP

# include <cstddef>

# include <boost/align/aligned_allocator.hpp>

# include <pastel/container/compressible_newtonian_sph_particles.hpp>
...
namespace pastel
{
  namespace container
  {
    ...
    using aligned_compressible_newtonian_sph_particles
      = ::pastel::container::_compressiblenewtonian_sph_particles<
...
#endif // PASTEL_CONTAINER_ALIGNED_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLES_HPP
