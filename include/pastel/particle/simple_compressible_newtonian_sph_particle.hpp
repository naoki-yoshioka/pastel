#ifndef PASTEL_PARTICLE_SIMPLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
# define PASTEL_PARTICLE_SIMPLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
...
namespace pastel
{
  namespace particle
  {
    ...
    class simple_compressible_newtonian_sph_particle;

    namespace simple_compressible_newtonian_sph_particle_detail
    {
      ...
      struct get< ::pastel::particle::tags::position, dimension_, Value, Point, Vector>
      {
        ...
        using particle_type = ::pastel::particle::simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>;
    ...
    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    class simple_compressible_newtonian_sph_particle final
    {
     public:
      ...
      static constexpr bool has_divergence = true;
     ...
     public:
      constexpr simple_compressible_newtonian_sph_particle() noexcept = default;
      ~simple_compressible_newtonian_sph_particle() noexcept = default;
      simple_compressible_newtonian_sph_particle(simple_compressible_newtonian_sph_particle const&) = default;
      simple_compressible_newtonian_sph_particle(simple_compressible_newtonian_sph_particle&&) noexcept = default;
      simple_compressible_newtonian_sph_particle& operator=(simple_compressible_newtonian_sph_particle const&) & = default;
      simple_compressible_newtonian_sph_particle& operator=(simple_compressible_newtonian_sph_particle&&) & noexcept = default;

      constexpr simple_compressible_newtonian_sph_particle(
      ...
      void swap(simple_compressible_newtonian_sph_particle& other)
        noexcept(
     ...
     private:
      ...
      friend class ::pastel::particle::simple_compressible_newtonian_sph_particle_detail::get;

      template <typename Tag>
      using simple_compressible_newtonian_sph_particle_get = ::pastel::particle::simple_compressible_newtonian_sph_particle_detail::get<Tag, dimension, Value, Point, Vector>;

     public:
      template <typename Tag>
      constexpr typename simple_compressible_newtonian_sph_particle_get<Tag>::reference get() & noexcept
      { return simple_compressible_newtonian_sph_particle_get<Tag>::call(*this); }

      template <typename Tag>
      constexpr typename simple_compressible_newtonian_sph_particle_get<Tag>::const_reference get() const& noexcept
      { return simple_compressible_newtonian_sph_particle_get<Tag>::call(*this); }

      template <typename Tag>
      constexpr typename simple_compressible_newtonian_sph_particle_get<Tag>::value_type get() && noexcept
      { return std::move(simple_compressible_newtonian_sph_particle_get<Tag>::call(*this)); }
    }; // class simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>

    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    inline bool operator==(
      ::pastel::particle::simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector> const& lhs,
      ::pastel::particle::simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector> const& rhs)
    {
      return
    ...
    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    inline void swap(
      ::pastel::particle::simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>& lhs,
      ::pastel::particle::simple_compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>& rhs)
...
#endif // PASTEL_PARTICLE_SIMPLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
