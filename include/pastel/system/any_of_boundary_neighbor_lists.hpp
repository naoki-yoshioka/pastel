...
namespace pastel
{
  namespace system
  {
      ...
      struct nth_step
      {
        ...
        static bool call(System const& system, Function&& function)
        {
          return function(::pastel::system::boundary_neighbor_list<n>(system), system)
            ...
            || ::pastel::system::any_of_boundary_neighbor_lists_detail::nth_step<n+4u, num-4u>::call(
    ...
    {
      return ::pastel::system::any_of_boundary_neighbor_lists_detail::nth_step<0u, ::pastel::system::meta::boundary_neighbor_list_tuple_size_of<System const>::value>::call(
        system, std::forward<Function>(function));
    }
  } // namespace system
} // namespace pastel
