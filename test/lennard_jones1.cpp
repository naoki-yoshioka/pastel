#define BOOST_TEST_MODULE Lennard-Jones1 test
...
BOOST_AUTO_TEST_CASE(lennard_jones1_test, * boost::unit_test::tolerance(0.001))
{
  ...
  using force_type = pastel::force::lennard_jones<>;
  ...
  using point_type = typename pastel::system::meta::point_of<system_type, 0u>::type;
  using vector_type = typename pastel::system::meta::vector_of<system_type, 0u>::type;
  using scalar_type = typename pastel::system::meta::scalar_of<system_type, 0u>::type;
  ...
  auto const x0 = pastel::geometry::get<0u>(pastel::container::get<pastel::particle::tags::force>(pastel::system::particles<0u>(system), 0u));
  auto const x1 = pastel::geometry::get<0u>(pastel::container::get<pastel::particle::tags::force>(pastel::system::particles<0u>(system), 1u));
  BOOST_TEST(x0 == -1.0);
  BOOST_TEST(x1 == +1.0);
}
