#ifndef PASTEL_PARTICLE_NEWTONIAN_SPH_PARTICLE_IO_HPP
# define PASTEL_PARTICLE_NEWTONIAN_SPH_PARTICLE_IO_HPP
...
namespace pastel
{
  namespace particle
  {
    ...
    std::basic_ostream<Character, CharacterTraits>& operator<<(
      ...
      ::pastel::particle::newtonian_sph_particle<dimension_, Value> const& particle)
    {
...
#endif // PASTEL_PARTICLE_NEWTONIAN_SPH_PARTICLE_IO_HPP
