#ifndef PASTEL_CONTAINER_IS_IMMOBILE_HPP
# define PASTEL_CONTAINER_IS_IMMOBILE_HPP
...
namespace pastel
{
  namespace container
  {
    ...
    template <typename Particles>
    inline bool is_immobile(Particles const& particles, typename Particles::size_type index)
    { return ::pastel::container::is_immobile_detail::call(particles, index, typename ::pastel::container::meta::mobility_tag_of<Particles>::type()); }

  } // namespace container
} // namespace pastel


#endif // PASTEL_CONTAINER_IS_IMMOBILE_HPP
