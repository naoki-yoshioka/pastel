#ifndef PASTEL_PARTICLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
# define PASTEL_PARTICLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
...
namespace pastel
{
  namespace particle
  {
    ...
    class compressible_newtonian_sph_particle;

    namespace compressible_newtonian_sph_particle_detail
    {
      ...
      struct get< ::pastel::particle::tags::position, dimension_, Value, Point, Vector>
      {
        ...
        using particle_type = ::pastel::particle::compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>;
    ...
    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    class compressible_newtonian_sph_particle final
    {
     public:
     ...
     public:
      constexpr compressible_newtonian_sph_particle() noexcept = default;
      ~compressible_newtonian_sph_particle() noexcept = default;
      compressible_newtonian_sph_particle(compressible_newtonian_sph_particle const&) = default;
      compressible_newtonian_sph_particle(compressible_newtonian_sph_particle&&) noexcept = default;
      compressible_newtonian_sph_particle& operator=(compressible_newtonian_sph_particle const&) & = default;
      compressible_newtonian_sph_particle& operator=(compressible_newtonian_sph_particle&&) & noexcept = default;

      constexpr compressible_newtonian_sph_particle(
        point_type const& position, vector_type const& velocity, vector_type const& force,
        scalar_type const& mass, scalar_type const& density, scalar_type const& sph_divergence, scalar_type const& pressure)
        : position_{position},
          velocity_{velocity},
          force_{force},
          mass_{mass},
      ...
      constexpr compressible_newtonian_sph_particle(
        ...
        scalar_type&& mass, scalar_type&& density, scalar_type&& sph_divergence, scalar_type&& pressure)
      ...
      void swap(compressible_newtonian_sph_particle& other)
        noexcept(
     ...
     private:
      ...
      friend class ::pastel::particle::compressible_newtonian_sph_particle_detail::get;

      template <typename Tag>
      using compressible_newtonian_sph_particle_get = ::pastel::particle::compressible_newtonian_sph_particle_detail::get<Tag, dimension, Value, Point, Vector>;

     public:
      template <typename Tag>
      constexpr typename compressible_newtonian_sph_particle_get<Tag>::reference get() & noexcept
      { return compressible_newtonian_sph_particle_get<Tag>::call(*this); }

      template <typename Tag>
      constexpr typename compressible_newtonian_sph_particle_get<Tag>::const_reference get() const& noexcept
      { return compressible_newtonian_sph_particle_get<Tag>::call(*this); }

      template <typename Tag>
      constexpr typename compressible_newtonian_sph_particle_get<Tag>::value_type get() && noexcept
      { return std::move(compressible_newtonian_sph_particle_get<Tag>::call(*this)); }
    }; // class compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>

    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    inline bool operator==(
      ::pastel::particle::compressible_newtonian_sph_particle<dimension_, Value, Point, Vector> const& lhs,
      ::pastel::particle::compressible_newtonian_sph_particle<dimension_, Value, Point, Vector> const& rhs)
    {
      return
    ...
    template <std::size_t dimension_, typename Value, typename Point, typename Vector>
    inline void swap(
      ::pastel::particle::compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>& lhs,
      ::pastel::particle::compressible_newtonian_sph_particle<dimension_, Value, Point, Vector>& rhs)
...
#endif // PASTEL_PARTICLE_COMPRESSIBLE_NEWTONIAN_SPH_PARTICLE_HPP
