#ifndef PASTEL_PARTICLE_SPH_PARTICLE_IO_HPP
# define PASTEL_PARTICLE_SPH_PARTICLE_IO_HPP
...
namespace pastel
{
  namespace particle
  {
    ...
    std::basic_ostream<Character, CharacterTraits>& operator<<(
      ...
      ::pastel::particle::sph_particle<dimension_, Value> const& particle)
    {
...
#endif // PASTEL_PARTICLE_SPH_PARTICLE_IO_HPP
