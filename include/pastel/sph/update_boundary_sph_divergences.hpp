#ifndef PASTEL_FORCE_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
# define PASTEL_FORCE_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
...
namespace pastel
{
  namespace force
  {
    namespace update_boundary_sph_divergences_detail
    {
      ...
      template <>
      struct update_boundary_sph_divergences<true, true, true, true>
      {
      ...
      template <>
      struct update_boundary_sph_divergences<true, true, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, true, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, true, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, false, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, false, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, false, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<true, false, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_boundary_sph_divergences<false, true, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
      ...
      template <>
      struct update_boundary_sph_divergences<false, true, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, true, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, true, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, false, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, false, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, false, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_boundary_sph_divergences<false, false, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
    ...
    inline void update_boundary_sph_divergences(Force const& force, NeighborList const& neighbor_list, System& system)
    {
      ...
      ::pastel::force::update_boundary_sph_divergences_detail::update_boundary_sph_divergences<is_sph_particles, is_partner_data_accessible, has_key_mass, has_partner_mass>::call(
        force, neighbor_list,
...
#endif // PASTEL_FORCE_UPDATE_BOUNDARY_SPH_DIVERGENCES_HPP
