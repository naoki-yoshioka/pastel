#ifndef PASTEL_SPH_UPDATE_DENSITIES_HPP
# define PASTEL_SPH_UPDATE_DENSITIES_HPP
...
namespace pastel
{
  namespace sph
  {
    namespace update_densities_detail
    {
      template <bool is_sph_particles_without_divergences, bool is_partner_data_accessible, bool has_key_mass, bool has_partner_mass>
      struct update_densities;

      template <>
      struct update_densities<true, true, true, true>
      {
        ...
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
          ...
          for (auto key = static_cast<decltype(num_keys)>(0); key < num_keys; ++key)
          {
            ...
            for (auto partner_index = static_cast<decltype(num_partners)>(0); partner_index < num_partners; ++partner_index)
            {
              ...
              ::pastel::container::get< ::pastel::particle::tags::density >(partner_particles, partner)
                += weight * key_mass;
            }
      ...
      template <>
      struct update_densities<true, true, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<true, true, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
          ...
          for (auto key = static_cast<decltype(num_keys)>(0); key < num_keys; ++key)
          {
            ...
            for (auto partner_index = static_cast<decltype(num_partners)>(0); partner_index < num_partners; ++partner_index)
            {
              ...
              key_density
                += weight * ::pastel::container::get< ::pastel::particle::tags::mass >(partner_particles, partner);
              ::pastel::container::get< ::pastel::particle::tags::density >(partner_particles, partner) += weight;
            }
            ::pastel::container::get< ::pastel::particle::tags::density >(key_particles, key) += key_density;
          }
        }
      ...
      template <>
      struct update_densities<true, true, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<true, false, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<true, false, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<true, false, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<true, false, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const& force, NeighborList const& neighbor_list, KeyParticles& key_particles, PartnerParticles& partner_particles)
        {
      ...
      template <>
      struct update_densities<false, true, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
      ...
      template <>
      struct update_densities<false, true, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, true, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, true, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, false, true, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, false, true, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, false, false, true>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
      ...
      template <>
      struct update_densities<false, false, false, false>
      {
        template <typename Force, typename NeighborList, typename KeyParticles, typename PartnerParticles>
        static void call(Force const&, NeighborList const&, KeyParticles const&, PartnerParticles const&)
        { }
    ...
    inline void update_densities(Force const& force, NeighborList const& neighbor_list, System& system)
    {
      ...
      ::pastel::force::update_densities_detail::update_densities<is_sph_particles_without_divergences, is_partner_data_accessible, has_key_mass, has_partner_mass>::call(
        force, neighbor_list,
...
#endif // PASTEL_SPH_UPDATE_DENSITIES_PRESSURES_HPP
