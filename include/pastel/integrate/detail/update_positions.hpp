  ...
  namespace integrate
  {
    namespace detail
    {
      namespace update_positions_detail
      {
        ...
        struct update_positions<0u, true, true, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time, typename MobilityTag>
          static void call(Particles const&, Time, MobilityTag)
          { }
        }; // update_positions<0u, true, true, AdditionalVectorIndexTuple

        template <typename AdditionalVectorIndexTuple>
        struct update_positions<0u, true, false, AdditionalVectorIndexTuple>
          : update_positions<0u, true, true, AdditionalVectorIndexTuple>
        { }; // update_positions<0u, true, false, AdditionalVectorIndexTuple

        template <typename AdditionalVectorIndexTuple>
        struct update_positions<0u, false, true, AdditionalVectorIndexTuple>
          : update_positions<0u, true, true, AdditionalVectorIndexTuple>
        { }; // update_positions<0u, false, true, AdditionalVectorIndexTuple

        template <typename AdditionalVectorIndexTuple>
        struct update_positions<0u, false, false, AdditionalVectorIndexTuple>
          : update_positions<0u, true, true, AdditionalVectorIndexTuple>
        { }; // update_positions<0u, false, false, AdditionalVectorIndexTuple


        // x_i(t+dt) = x_i(t) + v_i(t) dt
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<1u, true, true, AdditionalVectorIndexTuple>
        {
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<1u, true, false, AdditionalVectorIndexTuple>
          : update_positions<1u, true, true, AdditionalVectorIndexTuple>
        { }; // struct update_positions<1u, true, false, AdditionalVectorIndexTuple>

        template <typename AdditionalVectorIndexTuple>
        struct update_positions<1u, false, true, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time>
          static void call(Particles const&, Time, ::pastel::container::mobility_tags::immobile)
          { }
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<1u, false, false, AdditionalVectorIndexTuple>
          : update_positions<1u, false, true, AdditionalVectorIndexTuple>
        { }; // struct update_positions<1u, false, false, AdditionalVectorIndexTuple>


        // x_i(t+dt) = x_i(t) + v_i(t) dt + [f_i(t) / m_i] dt^2/2
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<2u, true, true, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time>
          static void call(Particles const&, Time, ::pastel::container::mobility_tags::immobile)
          { }
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<2u, false, true, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time>
          static void call(Particles const&, Time, ::pastel::container::mobility_tags::immobile)
          { }
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<2u, true, false, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time>
          static void call(Particles const&, Time, ::pastel::container::mobility_tags::immobile)
          { }
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<2u, false, false, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename Time>
          static void call(Particles const&, Time, ::pastel::container::mobility_tags::immobile)
          { }
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<3u, true, true, AdditionalVectorIndexTuple>
        {
          static_assert(
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<3u, false, true, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == 1u,
            "Size of AdditionalVectorIndexTuple must be equal to 1u");
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<3u, true, false, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == 1u,
            "Size of AdditionalVectorIndexTuple must be equal to 1u");
        ...
        template <typename AdditionalVectorIndexTuple>
        struct update_positions<3u, false, false, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == 1u,
            "Size of AdditionalVectorIndexTuple must be equal to 1u");
        ...
        struct update_positions_impl2
        {
          ...
          static constexpr auto derivative_index
            = std::tuple_element<index-3u, AdditionalVectorIndexTuple>::type::value;
            ...
            std::size_t particle_index)
          {
            ...
            ::pastel::integrate::detail::update_positions_detail::update_positions_impl2<index+1u, last, AdditionalVectorIndexTuple>::call(
              particles, derivative_coefficients, particle_index);
          }
        }; // struct update_positions_impl2<index, last, AdditionalVectorIndexTuple>

        template <std::size_t last, typename AdditionalVectorIndexTuple>
        struct update_positions_impl2<last, last, AdditionalVectorIndexTuple>
        {
          template <typename Particles, typename DerivativeCoefficients>
        ...
        struct update_positions<order, true, true, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == order - 2u,
            "Size of AdditionalVectorIndexTuple must be equal to order - 2u");
        ...
        template <std::size_t order, typename AdditionalVectorIndexTuple>
        struct update_positions<order, false, true, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == order - 2u,
            "Size of AdditionalVectorIndexTuple must be equal to order - 2u");
          ...
          static void call(Particles& particles, Time time_step, ::pastel::container::mobility_tags::mobile)
          {
            ...
            for (auto index = static_cast<decltype(num_particles)>(0); index < num_particles; ++index)
            {
              ...
              ::pastel::integrate::detail::update_positions_detail::update_positions_impl2<3u, order+1u, AdditionalVectorIndexTuple>::call(
        ...
        template <std::size_t order, typename AdditionalVectorIndexTuple>
        struct update_positions<order, true, false, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == order - 2u,
            "Size of AdditionalVectorIndexTuple must be equal to order - 2u");
        ...
        template <std::size_t order, typename AdditionalVectorIndexTuple>
        struct update_positions<order, false, false, AdditionalVectorIndexTuple>
        {
          static_assert(
            std::tuple_size<AdditionalVectorIndexTuple>::value == order - 2u,
            "Size of AdditionalVectorIndexTuple must be equal to order - 2u");
      ...
      inline void update_positions(Particles& particles, Time time_step)
      {
        ...
        using update_positions_func
          = ::pastel::integrate::detail::update_positions_detail::update_positions<order, is_data_accessible, has_mass, AdditionalVectorIndexTuple>;
        using mobility_tag
